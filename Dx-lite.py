...
except:ugen = ['Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X)'] #Aziz
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/5.0 (Linux; Android 11; vivo 1907; wv)'] #Aziz
...
\x1b[92;1m======================================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1m𝐷𝑋-𝐶𝑌𝐵𝐸𝑅 𝐵𝑂𝑌
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801979526394
\x1b[93;1m Team        \x1b[92;1m=>      \x1b[93;1m˜”*°•🔰DX-CYBER☣️TEAM☣️•°*”˜
\x1b[92;1m======================================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/Darkcyber6")
		exit()
	else:
		os.system("https://www.facebook.com/Darkcyber6")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [𝐷𝑋-𝐵𝑂𝑌] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
